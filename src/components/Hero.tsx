  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 py-10 md:py-12">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 items-center gap-8 lg:gap-12">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="text-base sm:text-lg text-gray-800 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-4">
              <a
                href="#contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-wine-800 text-white rounded-full shadow-md hover:bg-wine-900 focus:outline-none focus:ring-2 focus:ring-wine-400 transition-all duration-300 transform hover:-translate-y-1"
              >
              ...
              <a
                href="#projects"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-wine-800 text-wine-800 rounded-full hover:bg-wine-50 focus:outline-none focus:ring-2 focus:ring-wine-400 transition-all duration-300 transform hover:-translate-y-1"
              >
